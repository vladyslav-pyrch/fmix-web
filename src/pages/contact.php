...
<main class="main_">
    ...
    <h2 class="px-10 pb-4 pt-1.5 font-thin text-4xl">Kontakt</h2>
    <div class="flex flex-col-reverse m-10 mt-2.5 text-lg lg:flex-row items-center lg:gap-8 md:mx-10 md:mb-15">
        <div class="md:w-1/2">
