<section id="about_us" class="section">
	<div class="section_header" onclick="scrollToAndToggleOn('about_us')">
		<h2>O nás</h2>
	</div>

	<div id="about_us_content" class="toggle-content hide content w-full ">
		<div class="float-right mr-2.5 max-md:w-full md:w-1/2 ">
