  ...
  <div class="container mt-5">
    ...
    <form method="post" action="" class="shadow p-4 bg-light rounded">
      <div class="mb-3">
        ...
        <input type="text" id="firstname" name="firstname" placeholder="Meno" class="form-control" value="<?= htmlspecialchars($firstname ?? '') ?>" required>
      </div>

      <div class="mb-3">
        <label for="lastname" class="form-label">Priezvisko</label>
        <input type="text" id="lastname" name="lastname" placeholder="Priezvisko" class="form-control" value="<?= htmlspecialchars($lastname ?? '') ?>" required>
      </div>

      <div class="mb-3">
        <label for="nickname" class="form-label">Prezývka</label>
        <input type="text" id="nickname" name="nickname" placeholder="Prezývka" class="form-control" value="<?= htmlspecialchars($nickname ?? '') ?>" required>
      </div>

      <div class="mb-3">
        <label for="email" class="form-label">Mail</label>
        <input type="text" id="email" name="email" placeholder="Mail" class="form-control" value="<?= htmlspecialchars($email ?? '') ?>" required>
      </div>

      <div class="mb-3">
        <label for="school" class="form-label">Škola</label>
        <input type="text" id="school" name="school" placeholder="Škola" class="form-control" value="<?= htmlspecialchars($school ?? '') ?>" required>
      </div>

      <div class="mb-3">
        <label for="year_of_study" class="form-label">Navštevovaný ročník</label>
        <select type="number" id="year_of_study" name="year_of_study" placeholder="Navštevovaný ročník" class="form-control" min="1" max="4" value="<?= htmlspecialchars($year_of_study ?? '') ?>" required>
